...
class DQNAgent:
    ...
    def replay(self, episode):
        ...
        self.writer.add_scalar('Average_Q_Value', avg_q_value, episode)

        if self.epsilon > self.min_epsilon:
            self.epsilon *= self.epsilon_decay

    def log_metrics(self, total_reward, path_efficiency, steps, episode, collisions, phase="Training"):
        """Logs various metrics to TensorBoard."""
        self.writer.add_scalar(f'{phase}/Total_Reward', total_reward, episode)
        self.writer.add_scalar(f'{phase}/Path_Efficiency', path_efficiency, episode)
        self.writer.add_scalar(f'{phase}/Steps', steps, episode)
        self.writer.add_scalar(f'{phase}/Collisions', collisions, episode)
