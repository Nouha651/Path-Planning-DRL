...
class ContinuousEnv:
    def __init__(self):
        ...
        self.obstacles = [np.array([-7.0, -7.0]), np.array([-3.5, -3.5])]  # Add two obstacles
    ...
    def render(self, path=None):
        ...
        # Draw the obstacles with the specified size (convert position array to tuple of floats)
        for obstacle in self.obstacles:
