...
def main():
    ...
    # Define model paths
    models_dir = "models"
    actor_model_path = os.path.join(models_dir, f"actor_model_with_close_obstacles.pth")
    critic_model_path = os.path.join(models_dir, f"critic_model_with_close_obstacles.pth")
